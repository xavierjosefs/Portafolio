  ...
  return (
    ...
    >
      <div className="relative z-10 ml-10">
        <h1 className="text-sm md:text-lg font-bold tracking-[0.35em] uppercase text-black">
          {title}
        </h1>

        {text && (
          <p className="mt-3 text-xs sm:text-sm text-gray-700 leading-relaxed max-w-md">
            {text}
          </p>
        )}
      </div>
